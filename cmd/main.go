...
func init() {
	...
	utilruntime.Must(interpolatorv1.AddToScheme(scheme))
...
func main() {
	...
	mgr, err := ctrl.NewManager(ctrl.GetConfigOrDie(), ctrl.Options{
		...
		LeaderElectionID:       "e4c8630e.interpolator.io",
	...
	if err = (&controller.InterpolatorReconciler{
		...
		setupLog.Error(err, "unable to create controller", "controller", "Interpolator")
		os.Exit(1)
	}
