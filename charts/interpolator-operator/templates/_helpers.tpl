...
*/}}
{{- define "interpolator-operator.name" -}}
...
*/}}
{{- define "interpolator-operator.fullname" -}}
...
*/}}
{{- define "interpolator-operator.namespaceName" -}}
{{- .Release.Namespace }}
{{- end }}
...
*/}}
{{- define "interpolator-operator.resourceName" -}}
{{- $fullname := include "interpolator-operator.fullname" .context }}
{{- $suffix := .suffix }}
...
*/}}
{{- define "interpolator-operator.serviceAccountName" -}}
{{- if and (not (.Values.serviceAccount.enable | default true)) .Values.serviceAccount.name }}
{{- .Values.serviceAccount.name }}
{{- else }}
{{- include "interpolator-operator.resourceName" (dict "suffix" "controller-manager" "context" .) }}
{{- end }}
{{- end }}
